...
//			Calendar cal = new Calendar();
			...
			sb.append(year).append("년"); //년도 얻기
			sb.append(month).append("월"); //월 얻기
			...
			cal.set(Calendar.MONTH,3); //월 변경 1적게설정
//			cal.set(Calendar.DAY_OF_MONTH,2); //일 변경
			cal.set(Calendar.DAY_OF_MONTH,31); //현재월에 존재하지 않는 일로 설정하면 자바에서 자동으로 다음달 1일로 변경

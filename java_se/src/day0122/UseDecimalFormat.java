...
public class UseDecimalFormat {
	...
	public UseDecimalFormat() {
		...
		int i = 9_750_000; // JDK1.7에서부터는 숫자에 가독성을 향상시키기 위해서
		...
		System.out.println(sdf.format(2024));// 데이터가 없으면 0으로 채워서 반환
		...
		System.out.println(sdf4.format(2147483647));// 3자리 마다 ,를 넣어서 출력

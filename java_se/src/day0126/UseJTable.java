...
public class UseJTable extends JFrame {
	...
	public UseJTable() {
		...
		String[][] data = { { "1", "루피", "24", "test@test.com" }, { "2", "히루루크", "50", "hihi@test.com" },
				{ "3", "쵸파", "13", "" }, { "4", "상디", "27", "cook@test.com" },
		...
		//add(jtable);//스크롤바를 사용하지 않으면 컬러명이 보이지 않는다.
		add(jsp);//스크롤바를 사용하지 않으면 컬러명이 보이지 않는다.
